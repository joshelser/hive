 ...
 * 
 */
public class AccumuloTableParameters  {
...
//    super(conf);
//    String[] listColumns = conf.getStrings(serdeConstants.LIST_COLUMNS);
//
//    if (null == listColumns) {
//      throw new IllegalArgumentException("Configuration did not contain value for key '" + serdeConstants.LIST_COLUMNS + "'");
//    }
//
